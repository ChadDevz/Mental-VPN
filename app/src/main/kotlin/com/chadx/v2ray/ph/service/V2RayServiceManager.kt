...
import com.chadx.v2ray.ph.AppConfig.TAG_DIRECT
import com.chadx.v2ray.ph.R
import com.chadx.v2ray.ph.dto.ServerConfig
import com.chadx.v2ray.ph.extension.toSpeedString
import com.chadx.v2ray.ph.extension.toast
import com.chadx.v2ray.ph.ui.MainActivity
import com.chadx.v2ray.ph.util.MessageUtil
import com.chadx.v2ray.ph.util.MmkvManager
import com.chadx.v2ray.ph.util.Utils
import com.chadx.v2ray.ph.util.V2rayConfigUtil
import go.Seq
...
object V2RayServiceManager {
    ...
    fun titulongbahay(notificationconfigname: String) {
        // get configname from the spinner
        confignamepublic = notificationconfigname
    }
    ...
    private fun showNotification() {
        ...
        stopV2RayIntent.`package` = "com.vugarishk.cronoks.mentalvpn"
        ...
        mBuilder = NotificationCompat.Builder(service, channelId)
                ...
                .setContentTitle(confignamepublic)
    ...
    fun startSpeedNotification() {
        if (mSubscription == null && v2rayPoint.isRunning && settingsStorage?.decodeBool(AppConfig.PREF_SPEED_ENABLED) == true) {
